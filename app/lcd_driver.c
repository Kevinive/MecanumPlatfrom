...
void TFT_GPIO_Config(void) {
	...
	RCC_APB2PeriphClockCmd(
			RCC_APB2Periph_GPIOD | RCC_APB2Periph_GPIOE | RCC_APB2Periph_GPIOG
	...
	GPIO_InitStructure.GPIO_Pin = (GPIO_Pin_0 | GPIO_Pin_1 | GPIO_Pin_4
			| GPIO_Pin_5 | GPIO_Pin_8 | GPIO_Pin_8 | GPIO_Pin_9 | GPIO_Pin_10
...
void TFT_FSMC_Config(void) {
	...
	FSMC_NORSRAMTimingInitTypeDef FSMC_NORSRAMTiming = { 0 };
...
void TFT_SetWindow(uint16_t xStart, uint16_t yStart, uint16_t xEnd,
		uint16_t yEnd) {
	TFT_WriteCmd(0x2A);
